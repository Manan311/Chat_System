...
protected:
	...
	char rx_buffer[128]; //rx_buffer has only 128 bytes
	WSADATA wsa_data;
...
public:
	...
	void rec_mode(int); //handles received message, buffer state and active_sockets
	void send_mod(int); //handles message transmission, buffer state and active_sockets
...
public:
	...
	void get_messages(); //gets and prints any received messages
